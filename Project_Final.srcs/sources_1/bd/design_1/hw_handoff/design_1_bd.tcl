...
proc create_root_design { parentCell } {
  ...
  set je0 [ create_bd_port -dir O -type data je0 ]
  ...
  set OV_Sensor_ML_0 [ create_bd_cell -type ip -vlnv xilinx.com:ov2s:OV_Sensor_ML:1.0 OV_Sensor_ML_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT2_PORT {serialClk} \
  ...
  connect_bd_net -net GND_dout [get_bd_pins GND/dout] [get_bd_pins v_axi4s_vid_out_0/fid] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_reset] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_reset]
  ...
  connect_bd_net -net VCC_dout [get_bd_pins VCC/dout] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/axis_enable]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins v_tc_0/clken]
  connect_bd_net -net clk_wiz_0_pClk [get_bd_pins clk_wiz_0/pClk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  connect_bd_net -net clk_wiz_0_serialClk [get_bd_pins clk_wiz_0/serialClk] [get_bd_pins rgb2dvi_0/SerialClk]
  ...
  connect_bd_net -net cmos_pclk_i_0_1 [get_bd_ports cmos_pclk_i_0] [get_bd_pins OV_Sensor_ML_0/cmos_pclk_i]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins OV_Sensor_ML_0/CLK_i] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net processing_system7_0_TTC0_WAVE0_OUT [get_bd_ports je0] [get_bd_pins processing_system7_0/TTC0_WAVE0_OUT]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/aresetn]
  connect_bd_net -net v_axi4s_vid_out_0_locked [get_bd_ports locked_led] [get_bd_pins v_axi4s_vid_out_0/locked]
