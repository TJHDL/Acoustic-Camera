...
set_property PULLDOWN true [get_ports cmos_href_i_0]
set_property PULLDOWN true [get_ports cmos_pclk_i_0]
set_property PULLDOWN true [get_ports cmos_vsync_i_0]
