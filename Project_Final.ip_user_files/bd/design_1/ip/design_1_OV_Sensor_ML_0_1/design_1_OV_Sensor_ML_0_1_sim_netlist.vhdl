...
-- Date        : Mon Nov 11 16:18:26 2019
-- Host        : WINDOWS-GG72BL6 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_OV_Sensor_ML_0_1 -prefix
--               design_1_OV_Sensor_ML_0_1_ design_1_OV_Sensor_ML_0_1_sim_netlist.vhdl
-- Design      : design_1_OV_Sensor_ML_0_1
...
entity design_1_OV_Sensor_ML_0_1_cmos_decode is
  port (
...
end design_1_OV_Sensor_ML_0_1_cmos_decode;

architecture STRUCTURE of design_1_OV_Sensor_ML_0_1_cmos_decode is
  ...
  attribute SOFT_HLUTNM of \rgb565_o[15]_i_3\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \rgb565_o[4]_i_1\ : label is "soft_lutpair8";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_OV_Sensor_ML_0_1_count_reset_v1 is
  port (
    \cnt_reg[9]_0\ : out STD_LOGIC;
    CLK_i : in STD_LOGIC
  );
end design_1_OV_Sensor_ML_0_1_count_reset_v1;

architecture STRUCTURE of design_1_OV_Sensor_ML_0_1_count_reset_v1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_OV_Sensor_ML_0_1_OV_Sensor_ML is
  port (
    rgb_o : out STD_LOGIC_VECTOR ( 15 downto 0 );
    vid_clk_ce : out STD_LOGIC;
    hs_o : out STD_LOGIC;
...
end design_1_OV_Sensor_ML_0_1_OV_Sensor_ML;

architecture STRUCTURE of design_1_OV_Sensor_ML_0_1_OV_Sensor_ML is
  signal cmos_data_r : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal cmos_href_r : STD_LOGIC;
  signal cmos_vsync_r : STD_LOGIC;
  signal nolabel_line133_n_0 : STD_LOGIC;
begin
...
cmos_decode_u0: entity work.design_1_OV_Sensor_ML_0_1_cmos_decode
     port map (
      CLK_i => CLK_i,
      D(0) => cmos_vsync_r,
      ...
      \rst_n_reg_reg[4]_0\ => nolabel_line133_n_0,
...
nolabel_line133: entity work.design_1_OV_Sensor_ML_0_1_count_reset_v1
     port map (
      CLK_i => CLK_i,
      \cnt_reg[9]_0\ => nolabel_line133_n_0
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_OV_Sensor_ML_0_1 is
  port (
    CLK_i : in STD_LOGIC;
    cmos_vsync_i : in STD_LOGIC;
    cmos_href_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_OV_Sensor_ML_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_OV_Sensor_ML_0_1 : entity is "design_1_OV_Sensor_ML_0_1,OV_Sensor_ML,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_OV_Sensor_ML_0_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_OV_Sensor_ML_0_1 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_OV_Sensor_ML_0_1 : entity is "OV_Sensor_ML,Vivado 2019.1";
end design_1_OV_Sensor_ML_0_1;

architecture STRUCTURE of design_1_OV_Sensor_ML_0_1 is
...
inst: entity work.design_1_OV_Sensor_ML_0_1_OV_Sensor_ML
     port map (
      CLK_i => \^clk_i\,
